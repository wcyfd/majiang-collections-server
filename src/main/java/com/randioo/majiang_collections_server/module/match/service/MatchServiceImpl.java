...
import com.randioo.majiang_collections_server.util.vote.AllVoteExceptApplyerStrategy;
...
public class MatchServiceImpl extends ObserveBaseService implements MatchService {
    ...
    public void joinGame(Role role, String lockString) {
        ...
        SessionUtils.sc(role.getRoleId(),
                SC.newBuilder()
                        .setMatchJoinGameResponse(MatchJoinGameResponse.newBuilder().setRoundVideoData(roundVideoData)
