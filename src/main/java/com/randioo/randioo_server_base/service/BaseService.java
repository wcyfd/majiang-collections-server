...
public class BaseService implements BaseServiceInterface {
    ...
    public Logger logger = Log.create(LoggerFactory.getLogger(getSysName()), getSysName());
