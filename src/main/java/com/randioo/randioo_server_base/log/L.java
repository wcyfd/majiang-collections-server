...
public class L {
    ...
    public static final String ROLE_ACCOUNT_TAG = "<ROLE>[account:";
    public static final String SYS_TAG = "<SYS>";
    public static final String SPLIT_TAG = ",";
    /** 玩家格式 */
    private static final String ROLE_LOG_FORMAT = ROLE_ACCOUNT_TAG + "{0}" + SPLIT_TAG
            + "roleId:{1},name:{2}] * {3} * {4}";
    /** 系统格式 */
    private static final String SYSTEM_LOG_FORMAT = SYS_TAG + " {0} {1}";
